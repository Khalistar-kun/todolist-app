...
async function main() {
  console.log('🚀 Setting up complete task management database schema...\n')

  const success = await runMigration('complete-schema.sql')

  console.log(`\n${'='.repeat(50)}`)
  if (success) {
    console.log('✅ Database schema created successfully!')
    console.log('📊 Tables created: projects, project_members, tasks, workflows, workflow_steps, comments, attachments, notifications, user_profiles')
