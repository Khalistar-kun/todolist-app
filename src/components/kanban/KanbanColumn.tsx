      ...
      <div className="bg-white rounded-lg border border-gray-200 h-full flex flex-col">
        ...
        >
          {tasks.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-xs text-gray-400 mt-1">Drag tasks here to add them</p>
            </div>
          ) : (
        ...
        <div className="px-4 py-3 border-t border-gray-200">
          <button
            ...
            className="w-full flex items-center justify-center px-3 py-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-md transition-colors"
          >
