-- =====================================================
-- ULTIMATE FIX - Completely Remove ALL Recursion
...
-- This means the project_members SELECT policy is querying project_members itself!

\echo '============================================================'
\echo 'STEP 1: Drop ALL RLS policies'
\echo '============================================================'
...
\echo ''
\echo '============================================================'
\echo 'STEP 2: Create SIMPLE, NON-RECURSIVE policies'
\echo '============================================================'
...
-- The old policy had: WHERE om2.organization_id = organization_members.organization_id
-- This caused infinite recursion because it queries project_members FROM project_members!
-- =============================================================================
...
BEGIN
  ...
  RAISE NOTICE '   Run: SELECT tablename, COUNT(*) FROM pg_policies WHERE schemaname = ''public'' GROUP BY tablename;';
  RAISE NOTICE '';
  RAISE NOTICE '🎯 Next steps:';
  RAISE NOTICE '   1. Hard refresh browser (Ctrl+Shift+R)';
  RAISE NOTICE '   2. Check console for errors';
  RAISE NOTICE '   3. Try accessing projects';
  RAISE NOTICE '';
END $$;
